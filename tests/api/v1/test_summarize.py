...
from src.modules.knowledge.presentation.dependencies.channel_validation import get_channel_port, get_document_port, get_document_port_factory
...
from src.modules.knowledge.application.use_cases.summarize import SummarizeResult
